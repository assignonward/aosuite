...
{ // qDebug( "making data item type 0x%x size %d", typeCodeOf(di), di.size() );
  ...
  { 
      ...
      case AO_KEY_ASSET:               return new KeyAsset( di, p );
      ...
      case CB_COMPLETE:                return new GenericCollection( di, p );
      case CB_SIGNED:                  return new GenericCollection( di, p );
      case CB_CONTENTS:                return new GenericCollection( di, p );
...
{ switch ( ditm->typeCode )
  { 
      ...
      case AO_KEY_ASSET:               return new KeyAsset( *((KeyAsset *)ditm), p );
      ...
      case CB_COMPLETE:                return new GenericCollection( *((GenericCollection *)ditm), p );
      case CB_SIGNED:                  return new GenericCollection( *((GenericCollection *)ditm), p );
      case CB_CONTENTS:                return new GenericCollection( *((GenericCollection *)ditm), p );
